...
const {service, postService, fetchServices, deleteService} = useHospitalManagement()
              ...
              <div class="overflow-hidden rounded-lg border border-gray-200">
                <table class="w-full">
                  ...
                  <tr v-for="service in services" :key="service.id" class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                      <span class="text-gray-900 font-semibold bg-green-100 px-2 py-1 rounded-full" v-if="service.NHIS === true"> Yes</span>
