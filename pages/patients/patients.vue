                      ...
                      <td class="py-4 px-4">
                        <div class="flex gap-2">
                          ...
                          <NuxtLink :to="`/patients/patents_record/${item.id}`"
                                    class="bg-blue-500 hover:bg-blue-900 text-white px-3 py-1 rounded text-sm transition
                                       duration-200 transform hover:-translate-y-1 rounded-2xl">
                            Create a Document
                          </NuxtLink>


                          <NuxtLink :to="`/patients/past_record/${item.id}`" class="bg-emerald-500 hover:bg-emerald-900 rounded-2xl
                          text-white px-3 py-1 rounded text-sm transition duration-200 transform hover:-translate-y-1">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                 stroke="currentColor" class="size-6">
                              <path stroke-linecap="round" stroke-linejoin="round"
